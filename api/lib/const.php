...
const ERROR_FUNCTIONALITY_DISABLED = 1008;
const ERROR_TOKEN_EXPIRED = 1009;
...
const SIGNUP_SELF_TIMEOUT = PASSWORD_RESET_TIMEOUT;
const SIGNUP_INVITED_TIMEOUT = 5 * 24 * 60 * 60 * 1000; // 5d * 24h * 60m * 60s * 1000ms
